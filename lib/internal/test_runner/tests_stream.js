...
/* NOTE(RedYetiDev): The following line has been modified for node-core-test */
...
class TestsStream extends Readable {
  ...
  /* NOTE(RedYetiDev): The following lines have been modified for node-core-test */
  compose(stream, ...args) {
    if (stream === spec) stream = spec();
    return super.compose(stream, ...args);
  }
}
